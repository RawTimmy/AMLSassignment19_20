...
class Utils_A1:
    ...
    def train(self, img_train, label_train):
        ...
        # Parameter space for hyperparameter selection
        parameter_space ={
        ...
        clf = GridSearchCV(svm, parameter_space, n_jobs=4, cv=3, return_train_score=True)
        ...
        # Optional: Print out results of each parameter combo
