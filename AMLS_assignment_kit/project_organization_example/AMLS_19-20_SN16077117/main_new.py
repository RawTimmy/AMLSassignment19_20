...
# img_val_gender = scaler_gender.transform(img_val_gender.reshape((img_val_gender.shape[0], 68*2)))
#
# scaler_emo = StandardScaler()
# img_train_emo = scaler_emo.fit_transform(img_train_emo.reshape((img_train_emo.shape[0], 20*2)))
# img_val_emo = scaler_emo.transform(img_val_emo.reshape((img_val_emo.shape[0], 20*2)))
